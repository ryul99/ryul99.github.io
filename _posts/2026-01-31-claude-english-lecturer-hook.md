...
스크립트를 Claude Code config 디렉토리에 복사하거나 심볼릭 링크를 생성합니다.
...
실제 shell script 코드는 [여기](https://github.com/ryul99/.dotfiles/blob/master/home/claude/english-lecturer.sh)에서 확인할 수 있습니다.
